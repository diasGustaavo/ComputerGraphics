...
material.fragmentShader = `
    ...
    void main() {
        ...
        vec3 termoAmbiente = Ip_ambient_color * k_a;
        
        vec3 termoDifuso = Ip_diffuse_color * k_d * max(vec3(0.0, 0.0, 0.0), dot(N_cam_spc, L_cam_spc));
        
        vec3 termoEspecular = Ip_diffuse_color * k_s * pow(max(vec3(0.0, 0.0, 0.0), dot(R_cam_spc, normalize(vec3(P_cam_spc)))), vec3(16.0, 16.0, 16.0));
        
        vec3 total = termoAmbiente + termoDifuso + termoEspecular;
